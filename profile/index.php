            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="security-tab" style="display: none;">
                    ...
                    <div class="danger-zone">
                        ...
                        <p class="text-muted mb-3">Một khi bạn xóa tài khoản, không có cách nào để khôi phục lại. Vui lòng chắc chắn.</p>
                        <a href="<?php echo $base_url; ?>/profile/delete-account.php" class="btn btn-outline-danger">
