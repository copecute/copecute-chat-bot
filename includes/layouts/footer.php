...
try {
    $stmt = $pdo->prepare("SELECT setting_key, setting_value FROM system_settings 
                          WHERE setting_key IN ('footer_text', 'contact_email', 'contact_phone', 'contact_address')");
    $stmt->execute();
    $settings = [];
    ...
    $footer_text = $settings['footer_text'] ?? '© ' . date('Y') . ' copecute chat bot - Powered by copecute';
    $contact_email = $settings['contact_email'] ?? 'copecute@minhgiang.pro';
    $contact_phone = $settings['contact_phone'] ?? '+84 333 332 444';
    $contact_address = $settings['contact_address'] ?? 'Cao Bằng, Việt Nam';
} catch (PDOException $e) {
    $footer_text = '© ' . date('Y') . ' copecute chat bot - Powered by copecute';
    $contact_email = 'copecute@minhgiang.pro';
    $contact_phone = '+84 333 332 444';
    $contact_address = 'Cao Bằng, Việt Nam';
}
?>
            ...
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    ...
                    <div class="social-links">
                        <a href="#" class="me-2 text-muted"><i class="fab fa-facebook fa-lg"></i></a>
                        <a href="#" class="me-2 text-muted"><i class="fab fa-twitter fa-lg"></i></a>
                ...
                <div class="col-6 col-lg-2 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo $base_url; ?>/faq.php" class="text-decoration-none text-muted">FAQ</a></li>
                        <li class="mb-2"><a href="<?php echo $base_url; ?>/docs.php" class="text-decoration-none text-muted">Tài liệu</a></li>
                        <li class="mb-2"><a href="<?php echo $base_url; ?>/privacy.php" class="text-decoration-none text-muted">Chính sách</a></li>
                        <li class="mb-2"><a href="<?php echo $base_url; ?>/terms.php" class="text-decoration-none text-muted">Điều khoản</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2 text-muted"><i class="fas fa-map-marker-alt me-2"></i> <?php echo htmlspecialchars($contact_address); ?></li>
                        <li class="mb-2 text-muted"><i class="fas fa-envelope me-2"></i> <?php echo htmlspecialchars($contact_email); ?></li>
                        <li class="mb-2 text-muted"><i class="fas fa-phone me-2"></i> <?php echo htmlspecialchars($contact_phone); ?></li>
                    </ul>
                </div>
            </div>
